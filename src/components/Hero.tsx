...
const Hero = () => {
  ...
  return (
    <section id="inicio" className="pt-20 bg-gradient-to-br from-muted to-background min-h-screen flex items-center">
          ...
          <div className="space-y-8 animate-fade-in">
            ...
            <div className="grid grid-cols-3 gap-8 pt-8 border-t border-border">
              ...
              <div className="text-center">
                ...
                <div className="text-muted-foreground">TVs Reparadas</div>
              </div>
              <div className="text-center">
          ...
          <div className="lg:order-2 animate-fade-in">
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -left-6 bg-background p-6 rounded-xl shadow-lg">
                <div className="text-2xl font-bold text-primary">Diagnóstico</div>
